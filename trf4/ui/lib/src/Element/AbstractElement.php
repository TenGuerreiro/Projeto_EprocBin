...
abstract class AbstractElement extends FluidElementInterface
{
    ...
    public $hasValueSanitizing = false;
    ...
    /**
     * Método setter: define ou complementa o valor de um atributo. No caso de complementar, adiciona um espaço antes do próximo valor.
     * @param string $attr
     * @param $value
     * @param bool $replace
     * @return AbstractElement
     */
    public function attr(string $attr, $value, bool $replace = false): self
    {
        $shouldReplace = $replace || !isset($this->attrs[$attr]);
