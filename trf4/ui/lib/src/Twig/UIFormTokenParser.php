...
class UIFormTokenParser extends AbstractTokenParser
{
    ...
    public function parse(Token $token)
    {
            ...
            switch ($tag) {
                ...
                default:
                    throw new SyntaxError(
                        sprintf(
                            "Unexpected end of template. Twig was looking for the following tags '$endTag' to close the '$startTag' block started at line %d)",
                            $lineno
                        ), -1
                    );
            }
        ...
        return new UIFormNode(new Node($params), $lineno, $this->getTag());
    }
