...
class FileUpload extends \TRF4\UI\Component\FileUpload
{
    ...
    public function render(): string
    {
        ...
        $initialPreview = (isset($this->initFiles['url'])) ? "initialPreview: " . json_encode(
                $this->initFiles['url']
            ) . "," : "";
        $initialPreviewConfig = (isset($this->initFiles['config'])) ? "initialPreviewConfig:" . json_encode(
