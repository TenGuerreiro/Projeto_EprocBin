...
abstract class AbstractRenderer
{
    ...
    public abstract function getAutocompleteClass(): string;
    ...
    public abstract function getTimeClass(): string;
    ...
    public abstract function getInputResetClass(): string;
    ...
    public abstract function getMultiAutocompleteClass(): string;
