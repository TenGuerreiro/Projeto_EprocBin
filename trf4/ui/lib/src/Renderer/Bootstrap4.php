...
use TRF4\UI\Bootstrap4\InputButton;
use TRF4\UI\Bootstrap4\InputHidden;
use TRF4\UI\Bootstrap4\InputMask;
use TRF4\UI\Bootstrap4\InputNumber;
use TRF4\UI\Bootstrap4\InputReset;
use TRF4\UI\Bootstrap4\InputSubmit;
...
class Bootstrap4 extends AbstractRenderer
{
    ...
    {
        if ($el->_label && $el->getAttrId()) {
            $label = $el->_label->for($el->getAttrId());

            if (self::isRequired($el)) {
                if (!$el instanceof Radio || ($el instanceof Radio && !$el->inGroup)) {
    ...
    {
        return \TRF4\UI\Bootstrap4\Autocomplete::class;
    }
    ...
    {
        return \TRF4\UI\Bootstrap4\MultiAutocomplete::class;
    }
    ...
    protected static function hasPattern(FluidElementInterface $el): bool
    {
