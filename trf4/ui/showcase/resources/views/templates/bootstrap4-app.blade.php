...
@section('body-content')
    <nav class="navbar navbar-expand-lg navbar-light sticky-top d-flex justify-content-between">
        <div class="d-flex align-items-center">
            <a href="#mainContent" class="navbar-brand">
                <h1>TRF4\UI</h1>
                <small class="text-muted pl-2">{{ config('app.version') }}</small>
            </a>
        </div>
        ...
        <div class="custom-control custom-switch d-flex align-items-center">
            ...
            <a class="gitlab-logo ml-4"
               target="_blank"
               title="Ver no GitLab em nova janela"
               href="https://git.trf4.jus.br/infra_php/infra_php_fontes/blob/desenv/infra_php/ui">Gitlab</a>
        </div>
